...
function toggleFavorite(){let id=pool[idx],p=favorites.indexOf(id);if(p>=0)favorites.splice(p,1);else favorites.push(id);save();$("favBtn").textContent=favorites.includes(id)?"★":"☆"}
